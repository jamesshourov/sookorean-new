                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Edit Learn Category</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Learn Categories</a></li>
                                    <li class="breadcrumb-item active">Edit Learn Category</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <!-- end card header -->
                            <div class="card-body">
                                <form action="{{ route('learn-category.update') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="subtitle_japanese"
                                                      ...
                                                      rows="5">{{ $row->subtitle_japanese }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="subtitle_french"
                                                      ...
                                                      rows="5">{{ $row->subtitle_french }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="subtitle_spanish"
                                                      ...
                                                      rows="5">{{ $row->subtitle_spanish }}</textarea>
                                        ...
                                        <!--              rows="5" dir="rtl">{{ $row->description_arabic }}</textarea>-->
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select name="has_sub_category" class="form-select form-control sub-category" required onchange="handleSubCategory();">
                                                ...
                                                <option value="yes" @selected($row->has_sub_category == 'yes')>Yes</option>
                                                <option value="no" @selected($row->has_sub_category == 'no')>No</option>
                                            </select>
                                        </div>

                                        <div class="col-md-12 link" style="@if($row->has_sub_category == 'no' || empty($row->has_sub_category)) display: none @endif">
